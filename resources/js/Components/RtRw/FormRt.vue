    ...
    return {
      ...
      rules: {
        name: [
          {
            required: true,
            message: 'RT (Rukun Tetangga) tidak boleh kosong',
            trigger: 'blur',
          },
        ],
      },
        ...
        if (valid) {
          ...
          Inertia.visit(`${window.baseUrl}${this.url}`, {
            ...
            onSuccess: () => this.$notify({
              title: 'Sukses',
              message: `Berhasil ${message} RT (Rukun Tetangga)`,
              type: 'success',
            }),
            onError: () => this.$notify.error({
              title: 'Gagal',
              message: `Gagal ${message} RT (Rukun Tetangga)`,
              type: 'error',
            }),
          })
        } else {
